...
<body>
  ...
  <script type="text/babel">
    ...
    function CircleTile({ person, align, size, onOpen }) {
      ...
      return (
        <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true,amount:0.3}} transition={{duration:0.4}} style={{display:'flex', justifyContent:align==='right'?'flex-end':'flex-start', margin:'2rem 0', position:'relative'}}>
